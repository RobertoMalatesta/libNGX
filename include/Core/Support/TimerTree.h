...
#ifndef LIBNGX_CORE_SUPPORT_TIMERTREE
#define LIBNGX_CORE_SUPPORT_TIMERTREE
namespace ngx {
namespace Core {
namespace Support {
...
private:
    ...
    virtual int operator-(uint64_t R) const { return this->Timestamp > R ? 1 : -1; }
    virtual int operator-(RBNode &R) { return Timestamp > static_cast<Timer &>(R).Timestamp ? 1 : -1; }
