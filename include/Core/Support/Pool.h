...
#ifndef LIBNGX_CORE_SUPPORT_POOL
#define LIBNGX_CORE_SUPPORT_POOL
namespace ngx {
namespace Core {
namespace Support {
...
protected:
    const size_t BLOCK_SIZE = Config::POOL_MEMORY_BLOCK_SIZE;
    ...
    public:
        ...
        inline bool IsFreeBlock() { return RefCount == 0; }
